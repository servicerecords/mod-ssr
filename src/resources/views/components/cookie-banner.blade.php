<div id="global-cookie-message" class="govuk-clearfix" data-module="cookie-banner" role="region"
        ...
        <div class="govuk-grid-row">
            <div class="govuk-grid-column-two-thirds">
                <div>
                    ...
                    <p class="govuk-body">We use <a class="govuk-link" href="/help/cookies">cookies to collect
                ...
                <div>
                    ...
                    <div
                        ...
                        <a class="govuk-button govuk-!-width-full govuk-!-margin-bottom-1" role="button"
                           ...
                           data-track-action="Cookie banner settings clicked" href="/help/cookies">Set cookie
                            preferences</a>
                    </div>
                </div>
            </div>
    ...
    <div class="govuk-width-container" tabindex="-1">
        <p class="govuk-body" role="alert">You’ve accepted all cookies.
            You can <a class="govuk-link" href="/help/cookies" data-module="track-click"
        ...
        <a href="#" class="govuk" data-hide-cookie-banner="true" data-module="track-click"
