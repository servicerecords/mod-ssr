...
@section('content')
    ...
    <p class="govuk-body">
        Information you enter will be held temporarily and securely in line with our <a href="{{ route('cookie-policy') }}">cookie policy</a>.
    ...
    <p class="govuk-body">
        ...
        can be used as stated. We recommend that you read the <a
            href="https://www.gov.uk/government/organisations/ministry-of-defence/about/personal-information-charter">MOD's Personal Information Charter</a>
        and the <a
