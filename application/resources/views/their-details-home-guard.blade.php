        ...
        <div class="govuk-form-group {{ count($errors) >0 ? 'govuk-form-group--error' :'' }}">
            <fieldset class="govuk-fieldset">
                ...
                <div class="govuk-form-group">
                    <label class="govuk-label govuk-label--s" for="service_number">National Registration number
                        (optional)</label>
                    <input
                ...
                <div class="govuk-form-group">
                    ...
                    <textarea class="govuk-textarea" id="address" name="address" rows="5"
                              autocomplete="street-address">{{ isset($service_details['address'] ) ? $service_details['address'] : old('address') }}</textarea>
                </div>
