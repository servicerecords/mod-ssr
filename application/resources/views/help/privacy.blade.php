...
@section('content')
    ...
    <p class="govuk-body">When you request an historic service record you will be asked for a range of information,
        including your name and contact details, the name of your subject, their date of birth, and further information
        to help identify their records.
    </p>

    <p class="govuk-body">
        Information you enter will be held temporarily and securely in line with our <a href="/help/cookies">cookie
            policy</a>. We do this so you can progress through and complete your application. At the end of the process
        this information will be used to create an email request to the MOD Disclosure Branch. The cookies holding your
        information, and any uploaded documents, will be removed from your computer at the end of the process.
    </p>
    ...
    <p class="govuk-body">
        ...
        can be used as stated. We recommend that you read the <a
            ...
            Personal Information Charter</a> and the <a
