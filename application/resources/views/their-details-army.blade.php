        ...
        <div class="govuk-form-group {{ count($errors) >0 ? 'govuk-form-group--error' :'' }}">
            <fieldset class="govuk-fieldset">
                ...
                <div class="govuk-form-group">
                    ...
                    <span id="army-dis-1-item-hint" class="govuk-hint">Approximate if you are unsure</span>
                    <input value="{{ isset($service_details['discharge_year'] ) ? $service_details['discharge_year'] : old('discharge_year') }}"
                ...
                <div class="govuk-form-group">
                    ...
                    <span id="army-dis-1-item-hint" class="govuk-hint">At time of discharge</span>
                    <input value="{{ isset($service_details['regt_corps'] ) ? $service_details['regt_corps'] : old('regt_corps') }}"
