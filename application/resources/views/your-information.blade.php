        ...
        <div class="govuk-form-group {{ count($errors) >0 ? 'govuk-form-group--error' :'' }}">
            <fieldset class="govuk-fieldset">
                ...
                <div class="govuk-form-group">
                    ...
                    @endif
                    <input value="{{ isset($your_details['fullname'] ) ? $your_details['fullname'] : old('fullname') }}"
                           class="govuk-input {{"" !== $errors->first('fullname') ? 'govuk-input--error' : ''}}"
                           id="fullname" name="fullname" type="text" spellcheck="false" aria-required="true"
                ...
                <div class="govuk-form-group">
                    ...
                    @endif
                    <input value="{{ isset($your_details['email'] ) ? $your_details['email'] : old('email') }}"
                           class="govuk-input {{"" !== $errors->first('email') ? 'govuk-input--error' : ''}}" id="email"
                ...
                <div class="govuk-form-group">
                    ...
                    @if($errors->has('address_line_1'))
                        <span id="address-line-1-error"
                              class="govuk-error-message">Building number or name and street</span>
                    @endif
                    <input
                        value="{{ isset($your_details['address_line_1'] ) ? $your_details['address_line_1'] : old('address_line_1') }}"
                        class="govuk-input {{"" !== $errors->first('address_line_1') ? 'govuk-input--error' : ''}}"
                        id="address-line-1" name="address_line_1" type="text" aria-required="true"
                        aria-describedby="{{null !== $errors->first('address_line_1') ? 'address-line-1-error' : ''}}">
                </div>
                ...
                <div class="govuk-form-group">
                    ...
                    <input
                        value="{{ isset($your_details['address_line_2'] ) ? $your_details['address_line_2'] : old('address_line_2') }}"
                        class="govuk-input" id="address-line-2" name="address_line_2" type="text">
                </div>
                ...
                <div class="govuk-form-group">
                    ...
                    @endif
                    <input
                        value="{{ isset($your_details['address_town'] ) ? $your_details['address_town'] : old('address_town') }}"
                        class="govuk-input govuk-!-width-two-thirds {{"" !== $errors->first('address_town')}} ? 'govuk-input--error' : ''}}"
                        id="address_town" name="address_town" type="text">
                </div>
                ...
                <div class="govuk-form-group">
                    ...
                    @if($errors->first('address_postcode'))
                        <span id="service-error"
                              class="govuk-error-message">{{$errors->first('address_postcode')}}</span>
                    @endif
                    <input
                    ...
                    <fieldset class="govuk-fieldset">
                        ...
                        <div class="govuk-radios">
                            <div class="govuk-radios__item">
                                <input id="radio-inline-1" type="radio" name="use_billing" value="Yes"
                                       class="govuk-radios__input">
                                <label for="radio-inline-1"
                                       class="govuk-label govuk-radios__label govuk-label--s">Yes</label>
                            </div>
                            <div class="govuk-radios__item">
                                <input id="radio-inline-2" type="radio" name="use_billing" value="No"
                                       class="govuk-radios__input">
