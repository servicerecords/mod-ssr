...
class ArmyTest extends DuskTestCase
{
    use Interactions;
    ...
    public function testRegularServicePersonSuccess()
    {
        $this->browse(function (Browser $browser) {
            ...
            $browser->click('a.govuk-button.govuk-button--start')
                ...
                ->assertSee('Army (including Territorial & Army Emergency Reserve)');

            $browser->radio('#army', 'Army')
                ->press('Continue')
            ...
            $browser->screenshot('post-photo');
        });
    }


//    public function testDiedInServicePersonSuccess()
//    {
//        $this->browse(function (Browser $browser) {
//            $browser->visit('/')
//                ->assertSee('Apply for a deceased\'s military record');
...
//
//            $this->completeServicepersonDetails($browser);
//            $this->completeYourDetails($browser);
//
//            $browser->assertSee('Official Service Number (optional)');
//
//            $browser->screenshot('army-dis.jpg');
//        });
//    }
