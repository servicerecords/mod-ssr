                ...
                @endif
                    ...
                    <div class="govuk-radios govuk-radios--inline">
                        <div class="govuk-radios__item">
                            <input {{ (old('next_of_kin') == "Yes" || (isset($next_of_kin['next_of_kin']) && $next_of_kin['next_of_kin'] == "Yes")) ? 'checked' : '' }} class="govuk-radios__input" id="next_of_kin" name="next_of_kin" type="radio" value="Yes">
                            <label class="govuk-label govuk-radios__label" for="next_of_kin">
                                Yes
                            </label>
                        </div>
                        <div class="govuk-radios__item">
                            <input {{ (old('next_of_kin') == "No" || (isset($next_of_kin['next_of_kin']) && $next_of_kin['next_of_kin'] == "No")) ? 'checked' : '' }} class="govuk-radios__input" id="next_of_kin_2" name="next_of_kin" type="radio" value="No">
