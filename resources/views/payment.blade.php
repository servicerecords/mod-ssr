    ...
    <form id="card-details" name="cardDetails" method="POST" action="/pay">
        <div class="govuk-form-group {{ count($errors) >0 ? 'govuk-form-group--error' :'' }}">
            ...
            <div class="govuk-form-group">
                ...
                @endif
                <input id="card_number" type="tel" name="card_number" value="{{ old('card_number') }}" class="govuk-input {{"" !== $errors->first('card_number') ? 'govuk-input--error' : ''}}" />
            </div>
        </div>
        <div class="govuk-form-group" >
            <fieldset class="govuk-fieldset">
                ...
                <div class="govuk-date-input__item govuk-date-input__item--month govuk-date-input__item--with-separator">
                    ...
                    @if($errors->has('expiration_month'))
                        <span id="card_number-error" class="govuk-error-message">{{$errors->first('expiration_month')}}</span>
                    @endif
                    <input type="number" class="govuk-input govuk-input--width-3 {{"" !== $errors->first('expiration_month') ? 'govuk-input--error' : ''}}" id="expiration_month" value="{{ old('expiration_month') }}" name="expiration_month" />
                </div>
                <div class="govuk-date-input__item govuk-date-input__item--year">
                    ...
                    @if($errors->has('expiration_year'))
                        <span id="card_number-error" class="govuk-error-message">{{$errors->first('expiration_year')}}</span>
                    @endif
                    <input type="number" class="govuk-input govuk-input--width-3 {{"" !== $errors->first('expiration_year') ? 'govuk-input--error' : ''}}" id="expiration_year" value="{{ old('expiration_year') }}" name="expiration_year" />
                </div>
            </fieldset>
        </div>
        <div class="govuk-form-group">
            ...
            @endif
            <input id="name_on_card" type="text" name="name_on_cold" maxlength="200" class="govuk-input {{"" !== $errors->first('name_on_card') ? 'govuk-input--error' : ''}}" value="{{ old('name_on_card') }}" />
        </div>
        <div class="govuk-form-group">
            ...
            @if($errors->has('cvc'))
                <span id="card_number-error" class="govuk-error-message">{{$errors->first('name_on_card')}}</span>
            @endif
            <input type="number" name="cvc" class="govuk-input govuk-input--width-3 {{"" !== $errors->first('cvc') ? 'govuk-input--error' : ''}}" id="cvc" value="{{ old('cvc') }}" />
        </div>
        <div class="govuk-form-group pay-!-border-top govuk-!-padding-top-4">
            <fieldset class="govuk-fieldset">
                ...
                <div class="govuk-form-group">
                    ...
                    @endif
                    <input class="govuk-input {{"" !== $errors->first('address_line_1') ? 'govuk-input--error' : ''}}" id="address-line-1" name="address_line_1" type="text" aria-required="true" aria-describedby="{{"" !== $errors->first('address_line_1') ? 'address-line-1-error' : ''}}">
                </div>
                ...
                <div class="govuk-form-group">
                    ...
                    <input class="govuk-input govuk-!-width-two-thirds" id="address_town" name="address_town" type="text">
                </div>
                ...
                <div class="govuk-form-group">
                    ...
                    @endif
                    <input class="govuk-input govuk-!-width-two-thirds {{"" !== $errors->first('address_county') ? 'govuk-input--error' : ''}}" id="address-county" name="address_county" type="text" aria-required="true" aria-describedby="{{"" !== $errors->first('address_line_1') ? 'address-county-error' : ''}}">
                </div>
                ...
                <div class="govuk-form-group govuk-error">
                    ...
                    @endif
                    <input class="govuk-input govuk-input--width-10 {{"" !== $errors->first('address_postcode')}} ? 'govuk-input--error' : ''}}" id="address-postcode" name="address_postcode" type="text" aria-required="true" aria-describedby="{{"" !== $errors->first('address_postcode') ? 'address-postcode-error' : ''}}">
                </div>
            </fieldset>
        </div>
        <div class="govuk-form-group pay-!-border-top govuk-!-padding-top-4">
