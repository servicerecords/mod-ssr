            ...
            <fieldset class="govuk-fieldset">
                ...
                <div class="govuk-form-group">
                    ...
                    <div class="govuk-radios govuk-radios--conditional" data-module="radios">
                        ...
                        <div class="govuk-radios__conditional govuk-radios__conditional--hidden" id="conditional-relationship-1-conditional">
                            <div class="govuk-form-group">
                        ...
                        <div class="govuk-radios__item">
                            <input {{ (old('relationship') == "Grandchild" || (isset($your_details_relationship['relationship']) && $your_details_relationship['relationship'] == "Grandchild")) ? 'checked' : '' }} class="govuk-radios__input" type="radio" id="relationship-3" name="relationship" value="Grandchild">
                            <label class="govuk-label govuk-radios__label" for="relationship-3">I am their
                                grandchild</label>
                        </div>
                        <div class="govuk-radios__item">
                            <input {{ (old('relationship') == "Mother/Father" || (isset($your_details_relationship['relationship']) && $your_details_relationship['relationship'] == "Mother/Father")) ? 'checked' : '' }} class="govuk-radios__input" type="radio" id="relationship-4" name="relationship" value="Mother/Father" aria-controls="conditional-relationship-4-conditional" aria-expanded="false">
                            <label class="govuk-label govuk-radios__label" for="relationship-4">I am their
                                mother/father</label>
                        </div>
                        <div class="govuk-radios__conditional govuk-radios__conditional--hidden" id="conditional-relationship-4-conditional">
                            <div class="govuk-form-group">
                                <div class="govuk-checkboxes">
                                    <div class="govuk-checkboxes__item">
                        ...
                        <div class="govuk-radios__item">
                            <input {{ (old('relationship') == "Brother/Sister" || (isset($your_details_relationship['relationship']) && $your_details_relationship['relationship'] == "Brother/Sister")) ? 'checked' : '' }} class="govuk-radios__input" type="radio" id="relationship-5" name="relationship" value="Brother/Sister">
                        ...
                        <div class="govuk-radios__item">
                            <input {{ (old('relationship') == "Other" || (isset($your_details_relationship['relationship']) && $your_details_relationship['relationship'] == "Other")) ? 'checked' : '' }} class="govuk-radios__input" id="relastionship=8" name="relationship" type="radio" value="Other" aria-controls="conditional-relationship-8-conditional" aria-expanded="false">
                            <label class="govuk-label govuk-radios__label" for="relationship-8">
                                Other
                            </label> </div>
                        <div class="govuk-radios__conditional govuk-radios__conditional--hidden" id="conditional-relationship-8-conditional">
                            <div class="govuk-form-group">
                                <label class="govuk-label" for="relationship-8-other">
                                    Please specify
                                </label>
                                @if($errors->first('relationship_other'))
                                    <span id="service-error" class="govuk-error-message">{{$errors->first('relationship_other')}}</span>
                                @endif
                                <input value="{{(isset($your_details_relationship['relationship_other']) ? $your_details_relationship['relationship_other'] : old('relationship_other')) }}" class="govuk-input" id="relationship-8-other" name="relationship_other" type="text" spellcheck="false">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="govuk-form-group">
                    <details class="govuk-details" role="group">
                        ...
                        <div class="govuk-details__text" id="details-content-e0c053e5-5ef7-40ff-be62-f8146fe9ff57" aria-hidden="true">
