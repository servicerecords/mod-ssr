...
@section('content')
    ...
    <form action="/essential-information" method="post" class="govuk-form" id="subject-essentials"
        ...
        <div class="govuk-form-group {{ count($errors) >0 ? 'govuk-form-group--error' :'' }}">
            <fieldset class="govuk-fieldset">
                ...
                <div class="govuk-form-group">
                    ...
                    <span id="info-2-item-hint"
                          class="govuk-hint">For example, 31 3 1910. A year of birth is required.</span>
