...
@section('title', 'Accessibility statement for Request an historic service record')
...
@section('content')
    ...
    <ul class="govuk-list govuk-list--bullet">
        ...
        <li>listen to most of the website using a screen reader (including the most recent versions of JAWS, NVDA and VoiceOver)
            We've also made the website text as simple as possible to understand.</li>
    </ul>
    <p class="govuk-body">We've also made the website text as simple as possible to understand.</p>

    <p class="govuk-body"><a href="https://mcmw.abilitynet.org.uk/">AbilityNet</a> has advice on making your device easier to use if you have a disability.</p>
    ...
    <ul class="govuk-list govuk-list--bullet">
        <li>email <a href="mailto:DBSCIO-RAHSRFeedback@mod.gov.uk">DBSCIO-RAHSRFeedback@mod.gov.uk</a></li>
    ...
    <p class="govuk-body">The Equality and Human Rights Commission (EHRC) is responsible for enforcing the Public Sector Bodies (Websites and Mobile Applications) (No. 2) Accessibility Regulations 2018 (the 'accessibility regulations'). If you're not happy with how we respond to your complaint, contact the <a href="https://www.equalityadvisoryservice.com/">Equality Advisory and Support Service (EASS)</a>.
        [Note: if your organisation is based in Northern Ireland, refer users who want to complain to the Equalities Commission for Northern Ireland (ECNI) instead of the EASS and EHRC.]</p>

    <h2 class="govuk-heading-m">Contacting us by phone or visiting us in person</h2>

    <p class="govuk-body">We provide a text relay service for people who are D/deaf, hearing impaired or have a speech impediment.</p>
    <p class="govuk-body">Our offices have audio induction loops, or if you contact us before your visit we can arrange a British Sign Language (BSL) interpreter.</p>

    <h2 class="govuk-heading-m">Technical information about this website's accessibility</h2>
    <p class="govuk-body">The Ministry of Defence is committed to making its website accessible, in accordance with the Public Sector Bodies (Websites and Mobile Applications) (No. 2) Accessibility Regulations 2018.</p>
    <p class="govuk-body">This website is partially compliant with the Web Content Accessibility Guidelines version 2.1 AA standard, due to the non-compliances listed below.</p>
    ...
    <ul class="govuk-list govuk-list--bullet">
        <li>Non compliance with the accessibility regulations accessibility problems</li>
        <li>This interface has not been tested with all accessibility technologies.
            <ul class="govuk-list govuk-list--bullet">
                <li>which of the WCAG 2.1 AA success criteria the problem fails on 4.1.2 and 4.1.3 have not been tested with all assistive technologies</li>
                <li> when you plan to fix the problem we plan to continue testing in these areas.</li>
            </ul>
        </li>
    </ul>

    <h2 class="govuk-heading-m">How we tested this website</h2>
    <p class="govuk-body">This website was last tested on 17th February 2020. The test was carried out by the Ministry of Defence</p>
