        ...
        <div class="govuk-form-group">
            <div class="govuk-radios">
                <div class="govuk-radios__item">
                    <input class="govuk-radios__input" type="radio" id="reqtype" name="reqtype" value="Deceased"
                           checked="checked">
                    <label class="govuk-label govuk-radios__label" for="reqtype">I'm requesting the records of a
                        deceased serviceperson or Member of the Home Guard.
                        Available to family and non-family members. A death certificate is required if they did
                        not die in service.</label>
                </div>
                <div class="govuk-radios__item">
                    <input class="govuk-radios__input" type="radio" id="reqtype-other" name="reqtype" value="other"
                           disabled="disabled">
        ...
        <div class="govuk-form-group">
            <details class="govuk-details" role="group">
                <summary class="govuk-details__summary" role="button"
                         aria-controls="details-content-0e79c747-0c0d-403f-9f0b-e4de34f2be58" aria-expanded="false">
                            <span class="govuk-details__summary-text">
                                Why and when we need a death certificate
                            </span>
                </summary>
                <div class="govuk-details__text" id="details-content-0e79c747-0c0d-403f-9f0b-e4de34f2be58"
                     aria-hidden="true">
